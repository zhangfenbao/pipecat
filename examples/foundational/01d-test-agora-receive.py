...
class TestAgoraReceiver:
    def __init__(self):
        ...
        self.uid = 2  # 接收端UID
        self.token = "007eJxTYLh1LMh9Y9iviPlrwmfwZu7/NFlSznDxvUcMM0rvLp678K2JAkNyknmqYXJaokVasoGJsYW5ZYqJiYmluYWBuZmxgZFB2tt3NekNgYwM5nMfMjIyQCCIz8lQklpcEl+Un5/LwAAAnvUj6w=="  # 替换为你的Token
